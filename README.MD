...
## Input Format (Latin Tamil)

Use **Latin-transliterated Tamil** (not Tamil Unicode) for text input.

**Examples**:

* `"vanakkam"`
* `"neenga eppadi irukkiringa"`
* `"en per rajaa"`
* `"nandri"`

> ⚠️ Note: Unicode Tamil characters (e.g., வணக்கம்) are **not supported** in this POC.
